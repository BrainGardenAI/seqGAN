...
def train_generator_PG(gen, gen_opt, oracle, dis, num_batches):
    ...
    for batch in range(num_batches):
        ...
        inp, target = helpers.prepare_generator_batch(s)
...
if __name__ == '__main__':
    oracle = generator.Generator(hidden_dim=GEN_HIDDEN_DIM, output_size=OUTPUT_SIZE, max_seq_len=MAX_SEQ_LEN, oracle_init=True)
    oracle_samples = helpers.batchwise_sample(oracle, num_samples=POS_NEG_SAMPLES, batch_size=BATCH_SIZE)
    ...
    gen = generator.Generator(hidden_dim=GEN_HIDDEN_DIM, output_size=OUTPUT_SIZE, max_seq_len=MAX_SEQ_LEN)
    dis = discriminator.Discriminator(hidden_dim=DIS_HIDDEN_DIM, output_size=OUTPUT_SIZE, max_seq_len=MAX_SEQ_LEN)
